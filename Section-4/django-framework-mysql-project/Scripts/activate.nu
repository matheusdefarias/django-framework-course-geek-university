...
export-env {
    ...
    let virtual_env = 'C:\Users\Matheus Santos\Desktop\Estudos e repositorios\Backend\django-framework-course-geek-university\Section-4\django-framework-mysql-project'
    let bin = 'Scripts'
